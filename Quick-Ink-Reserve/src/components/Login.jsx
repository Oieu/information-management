  ...
  return (
    <>
      <div className='h-full w-full flex align-items-center relative'>
        <div className='absolute z-[-1] blur-sm opacity-50 bg-[url("https://images.unsplash.com/photo-1500964757637-c85e8a162699?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2103&q=80")] bg-cover bg-no-repeat h-full w-full '></div>
        ...
        <BackToHome color={"text-gray-300"} nav={nav} />
      </div>
    </>
  );
}
