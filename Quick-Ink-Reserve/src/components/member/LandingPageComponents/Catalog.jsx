    ...
    <div className="Catalog h-screen md:h-auto" id="catalog">
      ...
      <div className="Carousel w-full h-2/3 rounded-lg overflow-x-hidden overflow-y-scroll md:h-auto md:overflow-hidden">
        {services.map((service) => (
          <Link key={service.genServicesID} className="w-[90%] m-auto md:bg-gradient-to-r md:from-cyan-600 md:to-blue-700 text-gray-300 transition-all rounded-lg hover:bg-gradient-to-r hover:from-gray-800 hover:to-blue-950 hover:text-gray-100" to={`/service-avail/${service.genServicesID}`}>
